...
function Footer() {
    ...
    return(
            <div className="h-100 text-center bg-ivory font-bold">
                ...
                <div className="font-small">Studio Ghibli and all associated names and/or images are copyright Studio Ghibli. Images were freely collected from <a href=" https://ghibli.fandom.com/fr/wiki/Wiki_Studio_Ghibli" target="_blank">Ghibli Wiki</a>.</div>
            </div>
    )
}
